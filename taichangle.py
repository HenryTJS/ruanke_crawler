"""
为 JSON 文件中缺少 "year" 键的对象添加默认年份列表。
用法：
...
DEFAULT_YEARS = [2025, 2024, 2023, 2022, 2021, 2020, 2019, 2018, 2017, 2016, 2015, 2014, 2013, 2012, 2011, 2010, 2009]


def add_year_to_objects(data):
    """递归处理数据，为缺少 'year' 键的字典添加默认年份列表。"""
